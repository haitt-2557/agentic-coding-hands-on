...
# SCR-AwardSystem — Screen Spec

**Screen**: SCR-AwardSystem (mã SCR### thật cấp lúc promote): Hệ thống giải thưởng SAA 2025
**Feature**: Hệ thống giải thưởng SAA 2025 (Award System Page) [F### cấp lúc promote]
**Type**: atomic
**Route**: `/awards`
