...
# Technical Spec — Hệ thống giải thưởng SAA 2025 (Award System Page) [mã F### cấp lúc promote]
...
gate nào ở lượt này),
[`screen-flow.md`](../../../../docs/vi/generated/screen-flow.md) (không có guard mới; deep-link
...
| API Map | [api-map.md](../../../../docs/vi/generated/api-map.md) | N/A — không có route API mới (site tĩnh) | [ ] |
| Entities | [entities.md](../../../../docs/vi/generated/entities.md) | TBD (draft) — MODEL### cấp lúc promote | [ ] |
| Screens | [screens.md](screens.md) | TBD (draft) — SCR### cấp lúc promote | [ ] |
| Behavior Logic | [behavior-logic.md](../../../../docs/vi/generated/behavior-logic.md) | TBD (draft) — BL### cấp lúc promote (dự kiến 0, không có background job) | [ ] |
| Permissions Matrix | [permissions-matrix.md](../../../../docs/vi/generated/permissions-matrix.md) | N/A — route vẫn công khai, không thêm PERM### | [ ] |
